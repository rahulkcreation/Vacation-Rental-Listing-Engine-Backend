...
function leb_render_type_management_page() {
    ...
    if ( $leb_action === 'edit' || $leb_action === 'add' ) {
        require_once LEB_PLUGIN_DIR . 'templates/add-edit-type.php';
    } else {
        require_once LEB_PLUGIN_DIR . 'templates/type-management.php';
    }
}
...
function leb_render_database_page() {
    ...
    require_once LEB_PLUGIN_DIR . 'templates/database-page.php';
}

// ─────────────────────────────────────────────────────────────
// Plugins Page Settings Link
// ─────────────────────────────────────────────────────────────
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), 'leb_add_settings_link' );
