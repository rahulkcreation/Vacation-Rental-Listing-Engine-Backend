...
(function (window, document) {
  ...
  var LEB_Confirm = {
    ...
    init: function () {
      ...
      // Bind events.
      var self = this;
      document.getElementById("leb-confirm-cancel").onclick = function () {
        self.hide();
        if (self.onCancel) self.onCancel();
      };
      document.getElementById("leb-confirm-ok").onclick = function () {
        self.hide();
    ...
    show: function (settings) {
      ...
      if (messageEl)
        messageEl.textContent = settings.message || "Are you sure?";
      ...
      if (iconBox) {
        iconBox.className =
          "leb-confirm-icon-box " + (settings.type || "leb-warning");
      }
