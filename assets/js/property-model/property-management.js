    ...
    function renderCards(items) {
        ...
        DOM.body.innerHTML = items.map(function (item, index) {
            ...
            return '<div class="leb-pm-card" data-id="' + item.id + '">'
                ...
                +     'Edit'
                +   '</a>'
                +   '<button class="leb-pm-action-btn leb-pm-duplicate-btn" type="button" data-id="' + item.id + '">'
        ...
        if (DOM.body) {
            ...
            DOM.body.addEventListener('click', function (e) {
                ...
                if (dupBtn) {
                    ...
                    if (!id) return;
                    performAJAXAction('leb_listing_duplicate', [id], 'Property duplicated successfully.', function () {
                        fetchListings();
                    });
                }
            });
